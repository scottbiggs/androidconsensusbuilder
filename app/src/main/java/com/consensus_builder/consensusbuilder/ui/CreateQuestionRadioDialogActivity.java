 ...
 * allows the user to make a new radio button Question as part of their questionnaire.
 *
 * This Activity communicates with and is started by the QuestionnaireFragment.
 */
public class CreateQuestionRadioDialogActivity extends Activity {

    //----------------------------
    //  Constants
    //----------------------------

    private static final String TAG = CreateQuestionRadioDialogActivity.class.getSimpleName();

    /** Id used to identify this particular Activity when it returns values to the caller */
    public static final int CREATE_QUESTION_RADIO_ID = "CREATE_QUESTION_RADIO_ID".hashCode();
    ...
    private RadioQuestionView mQuestionView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.create_question_radio);

        mQuestionView = (RadioQuestionView) findViewById(R.id.radio_view);
    ...
    protected void user_ok() {
        ...
        if (q.numRadioButtons() == 0) {
            // todo:  dialog warning that no radio buttons have been added.
        }
