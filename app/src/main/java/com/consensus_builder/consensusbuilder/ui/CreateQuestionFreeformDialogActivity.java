 ...
 * allows the user to make a new freeform Question as part of their questionnaire.
 *
 * This Activity communicates with and is started by the QuestionnaireFragment.
 */
public class CreateQuestionFreeformDialogActivity extends Activity {

    //----------------------------
    //  Constants
    //----------------------------

    private static final String TAG = CreateQuestionFreeformDialogActivity.class.getSimpleName();

    /** Id used to identify this particular Activity when it returns values to the caller */
    public static final int CREATE_QUESTION_FREEFORM_ID = "CREATE_QUESTION_FREEFORM_ID".hashCode();
    ...
    private FreeformQuestionView mQuestionView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.create_question_freeform);

        mQuestionView = (FreeformQuestionView) findViewById(R.id.freeform_view);
